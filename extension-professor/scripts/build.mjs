...
copyFileSync('fullscreen.html', 'out/fullscreen.html');
console.log('✓ fullscreen.html → out/fullscreen.html');

copyFileSync('fullscreen.js', 'out/fullscreen.js');
console.log('✓ fullscreen.js → out/fullscreen.js');
